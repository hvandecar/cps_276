...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'hvandecar';//this will be your WCC username
      $dbUsr = 'hvandecar';//this will be your WCC username
      $dbPass = 'D52z33xybBD8';//this will be the password found in the video.
